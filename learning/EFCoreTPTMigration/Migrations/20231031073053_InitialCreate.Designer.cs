...
namespace EFCoreTPTMigration.Migrations
{
    ...
    [Migration("20231031073053_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreTPCMigration.Models.SecurityGroup", b =>
                {
                    b.HasOne("EFCoreTPCMigration.Models.Identity", null)
                        .WithOne()
                        .HasForeignKey("EFCoreTPCMigration.Models.SecurityGroup", "Id")
            ...
            modelBuilder.Entity("EFCoreTPCMigration.Models.User", b =>
                {
                    b.HasOne("EFCoreTPCMigration.Models.Identity", null)
                        .WithOne()
                        .HasForeignKey("EFCoreTPCMigration.Models.User", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
